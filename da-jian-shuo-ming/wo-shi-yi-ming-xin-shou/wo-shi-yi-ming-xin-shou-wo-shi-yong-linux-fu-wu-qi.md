...
```text
######################必填信息#####################
######系统(务必修改为自己的机器、端口、骰子QQ号)#######
#主机的外网IP，服务器的话很好找，个人电脑的话请百度如何找，肯定不是192或172开头
hostIp=localhost
#httpApi的默认端口就是9999与80，没有特殊必要无需更改
javaPort=50070
serverPort=9999
#####################数据库信息#####################
#无需修改
...
```text
#主机的外网IP，服务器的话很好找，个人电脑的话请百度如何找，肯定不是192或172开头,这里默认填写值为本机
hostIp=127.0.0.1
#httpApi的默认端口就是9999与80，没有特殊必要无需更改
javaPort=50070
serverPort=9999
